...
import logo from "/8__1_-removebg-preview.png";

export default function Landing() {
  return (
    <div style={ padding: '2rem', fontFamily: 'sans-serif', textAlign: 'center' }>
      <img src={logo} alt="Hub31 Logo" style={ height: 100 } />
      ...
      <a href="https://wa.me/254720860034" target="_blank">
        <button style={ padding: '0.75rem 1.5rem', backgroundColor: '#25D366', color: 'white', border: 'none', fontWeight: 'bold', margin: '0.5rem' }>
          Start on WhatsApp
        </button>
      </a>

      <a href="https://t.me/Hub31AIBot" target="_blank">
        <button style={ padding: '0.75rem 1.5rem', backgroundColor: '#0088cc', color: 'white', border: 'none', fontWeight: 'bold', margin: '0.5rem' }>
          Launch via Telegram
        </button>
      </a>
      ...
      <div style={ marginTop: '2rem' }>
        ...
        <a href="https://forms.gle/h1ogqTrm2ZMVLFEw6" target="_blank">
          <button style={ padding: '0.75rem 1.5rem', backgroundColor: '#FFD700', color: '#333', border: 'none', fontWeight: 'bold' }>
            Fill Launch Form
          </button>
        </a>
      </div>
